...
<%--                            <button type="reset" class="btn" style="margin-top:10px">重置</button>--%>
		...
		%>
	        ...
	        <div class="copyright text-center" style="padding-top:1rem;">
	            <p class="copy-footer-29" style="font-size: 12px; color: gray;"><a href="http://www.kefu.zvo.cn" target="_black" style="color: gray;">Copyright © 2016-<%=nowYear %>,  power by yunkefu </a></p>
	        </div>
	         -->
		<% } %>
