...
<div id="shifouqiyong" class="layui-form" style="padding-top:10%; text-align:center;">
	...
	<input type="checkbox" id="switchInputId" name="isUse" value="1" lay-filter="isUse" lay-skin="switch" lay-text="开启|关闭" <c:if test="${limitBuyStore.isUse == 1}">checked</c:if>>
...
function updateLimitNumber(value){
	...
	$.post("updateLimitNumber.json?value="+value, function (result) { 
       	parent.msg.close();
