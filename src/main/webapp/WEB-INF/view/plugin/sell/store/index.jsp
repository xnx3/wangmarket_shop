...
<li class="layui-nav-item">
    <a href="javascript:loadUrl('set.do');" >参数设置</a>
</li>
<li class="layui-nav-item">
    <a href="javascript:loadUrl('/plugin/sell/store/commission/list.do');" >佣金记录</a>
</li>
<li class="layui-nav-item">
    <a href="javascript:loadUrl('/plugin/sell/store/tixian/list.do');" >提现申请</a>
</li>
<!-- 子菜单结束，下面的每个li便是一个菜单项 -->
<jsp:include page="../../../iw/common/adminSubMenu/foot.jsp" />
<!-- 进入这个页面后，最右侧内容区域默认打开的链接地址 -->
<script>loadUrl('set.do');</script>