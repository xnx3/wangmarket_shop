...
<table class="layui-table iw_table"  id="tbody">
...
post('/shop/superadmin/store/storeDetailsView.json?id='+ id,{},function(data){
    ...
    if(data.result != '1'){
        ...
        //列表
        var html = '';
        html = html + goodsListDate(data.store);
        
        document.getElementById("tbody").innerHTML = html;

        if(data.store.state == 0){
            document.getElementById("state").innerHTML = '审核中';
        }else if(data.store.state == 1){
