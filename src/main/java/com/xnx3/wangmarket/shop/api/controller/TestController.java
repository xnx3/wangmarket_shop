 ...
 * @author 管雷鸣
 */
@Controller(value="ShopTestController")
@RequestMapping("/shop/api/test/")
public class TestController extends BaseController {
	...
	public static WeiXinPayUtil payUtil;
	static{
		String appId = "wxae29273f418487db";
		String appSecret = "ed9dc714874eb9524d6319fa09f31bcd";
		String token = "xnx3Test";
		weiXinUtil = new WeiXinUtil(appId, appSecret, token);
		System.out.println(weiXinUtil.getAccessToken());
		System.out.println(weiXinUtil.getOauth2ExpertUrl("http://shop.imall.net.cn/"));
		
		String shanghu_mch_id = "1581125931";
		String shanghu_key = "ed9dc714874eb9524d6319fa09f31bcd";
		payUtil = new WeiXinPayUtil(appId, shanghu_mch_id, shanghu_key);
	}
	...
	public static void main(String[] args) {
		...
		payOrderBean.setOpenid("oqe4IuOW_M8hCrT2g0zMKo8EhDV4");
		payOrderBean.setTotalFee(1);
		payUtil.createOrder(payOrderBean, new CreateOrderInterface() {
	 ...
	 * 获取当前登录的用户信息,入口
	 */
	@RequestMapping(value="entry${api.suffix}")
	public String entry(HttpServletRequest request,HttpServletResponse response) throws IOException{
		String url = weiXinUtil.getOauth2ExpertUrl("http://shop.imall.net.cn/shop/api/test/pay.json");
		return redirect(url);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/pay${api.suffix}")
	public BaseVO pay(HttpServletRequest request){
		String code = request.getParameter("code");
		if(code == null || code.length() == 0){
			return error("code 不存在");
		}
		//拿到用户的openid
		String openid = weiXinUtil.getOauth2OpenId(code);
...
class WeiXinPayUtil {
	...
	private String gongzhonghao_appid;	//公众号的appid
	 ...
	 */
	public WeiXinPayUtil(String gongzhonghao_appid, String shanghu_mch_id, String shanghu_key) {
		this.gongzhonghao_appid = gongzhonghao_appid;
...
//        paraMap.put("openid", bean.getOpenid());
        ...
        paramBuffer.append("<appid>"+gongzhonghao_appid+"</appid>");
