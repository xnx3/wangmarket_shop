...
public class Order extends BaseGenerate {
	...
	public void state() {
		...
		cacheAdd(com.xnx3.wangmarket.shop.core.entity.Order.STATE_PAY, "已付款");
		cacheAdd(com.xnx3.wangmarket.shop.core.entity.Order.STATE_PAYTIMEOUT_CANCEL, "超时取消");
		cacheAdd(com.xnx3.wangmarket.shop.core.entity.Order.STATE_RECEIVE_GOODS, "已确认收货");
		cacheAdd(com.xnx3.wangmarket.shop.core.entity.Order.STATE_DISTRIBUTION_ING, "配送中");
		cacheAdd(com.xnx3.wangmarket.shop.core.entity.Order.STATE_PRIVATE_PAY, "线下支付");
		generateCacheFile();
	}
}
